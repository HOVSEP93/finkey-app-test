...
const ServicesGroupA = () => {
  return (
    <section id="Tradies and Installers" className="px-5 sm:px-10 md:px-14">
      <div className="py-5">
        <div className="max-w-4xl mx-auto space-y-1.5 text-center">
          ...
          <h1 className="leading-9 sm:leading-[50px] md:leading-[60px] tracking-tight text-gray-900 text-[26px] xs:text-[36px] sm:text-[40px] md:text-5xl">
            Check your eligibility in less than two minutes and apply online in
            10 minutes. You can enjoy your funds as soon as the next day.
          </h1>
        </div>
