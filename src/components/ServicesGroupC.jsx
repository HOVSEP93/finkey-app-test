        ...
        >
          ...
          <div className="flex flex-col gap-x-5 justify-between space-y-7 md:flex-row md:space-y-0 ">
            <div className="p-4  w-full  mx-auto md:mx-0 max-w-lg sm:max-w-xl md:max-w-md">
              ...
              />
              <Accordion
                question="GREEN RENOVATION LOANS"
              ...
              />
              <Accordion
                question="GREEN REPAIR LOAN"
                answer="Nisi anim cupidatat excepteur officia. Reprehenderit nostrud nostrud ipsum Lorem est aliquip amet voluptate voluptate dolor minim nulla est proident."
              />
            </div>
